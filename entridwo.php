    ...
    <div class="box-body">
      <form action="tambah_dropwo.php" method="post">
        <div class="form-group col-md-6">
          <label>Bidang</label>
          <input type="text" class="form-control" placeholder="Bidang .." name="Bidang" value="<?php echo $lihat1['nama_bag'];?>" required>
        </div>
        <div class="form-group col-md-6">
          ...
          <div class="input-group date">
            ...
            <input type="text" class="form-control pull-right" name="tanggal_mulai" id="datepicker" required>
          </div>
          <!-- /.input group -->
        </div>
        ...
        <div class="form-group col-md-12">
          ...
          <select class="form-control" id="id" name="tindakan" required>
        ...
        <div>
          ...
          <div id="operbidang" style="display:none;" class="form-group col-md-12">
            ...
            <select class="form-control" id="idoper" name="id_oper" required>
  ...
  $(document).ready(function(){
    $('status1').on('change',function(){
      if(this.value="proses"){
        ...
        $('#operbidang').hide();
        document.getElementById('id_oper').setValue(null);
      }
    });
  });
</script>